...
class Pipe(pg.sprite.Sprite):
    ...
    def __init__(self, pipe_end_img, pipe_body_img):
        ...
        self.bottom_pieces = np.random.randint(1, total_pip_body_pieces)
        self.top_pieces = total_pip_body_pieces - self.bottom_pieces
        ...
        self.passage_center_y = (top_pipe_end_y + bottom_pipe_end_y) / 2
